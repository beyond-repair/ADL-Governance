...
| adl-capability-matrix row count 67 vs live 77 | Medium | OPEN |
| Dependabot PRs #5/#6 + evidence PR #7 + #3/#4 on workforce | Medium | OPEN |
...
| aegis-repo-graph catalog snapshot vs live 77 | Low | OPEN (operator expansion) |
