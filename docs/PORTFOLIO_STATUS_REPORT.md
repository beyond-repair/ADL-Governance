...
| Project-Cold-Boot | workflows total_count=0 | no CI | n/a |
| blacksite | workflows total_count=0 | no CI | n/a |
...
- [x] No unsupported claims (controlled; Project-Cold-Boot / blacksite / ExoAxis-1 claim ≤1)
